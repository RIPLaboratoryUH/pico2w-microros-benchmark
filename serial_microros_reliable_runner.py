#!/usr/bin/env python3
"""
serial_microros_runner.py  —  Serial micro-ROS RTT experiment runner.
...
Prerequisites (in order):
    ...
    4. Run this script:
           python3 serial_microros_runner.py --freq 100 --run 1

Output:
    data/serial_microros_100hz_run01_<timestamp>.csv
"""
...
class SerialMicroROSRunner(Node):
    ...
    def __init__(self, freq_hz: int, run_idx: int):
        super().__init__("serial_microros_runner")
    ...
    def save_csv(self):
        ...
        n_dropped = TOTAL_MSGS - n_replied
...
def main():
    parser = argparse.ArgumentParser(
        description="Serial micro-ROS RTT runner"
    )
    parser.add_argument(
    ...
    rclpy.init()
    node = SerialMicroROSRunner(freq_hz=args.freq, run_idx=args.run)
